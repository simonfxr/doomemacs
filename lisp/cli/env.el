    ...
    (with-temp-file env-file
      ...
      (print-group!
        ...
        (insert
         ...
         ";; ---------------------------------------------------------------------------\n"
         ";; This file was generated by `doom env'. It contains a list of environment\n"
         ...
         (if (file-equal-p env-file doom-env-file)
             (concat ";; It is NOT safe to edit this file. Changes will be overwritten next time\n"
                     ";; 'doom sync' is run. To create a safe-to-edit envvar file use:\n;;\n"
                     ";;   doom env -o ~/.doom.d/env.el\n;;\n"
